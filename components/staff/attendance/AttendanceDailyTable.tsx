                                ...
                                >
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col gap-1.5">
                                            ...
                                            {record.logoutType && (
                                                <span className="text-[8px] font-black text-primary-500/70 pl-2 uppercase tracking-[0.1em] mt-1 italic">
                                                    {record.logoutType === 'STAY_IN_OFFICE' ? 'In Office' :
                                                        record.logoutType === 'ON_WORK' ? 'On Work' : 'Logout'}
                                                </span>
                                            )}
                                        </div>
                                    </td>
